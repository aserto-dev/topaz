...
// 				return preservedFile(fmt.Errorf("%s", "Edit canceled, no valid changes were saved."), file, o.ErrOut)
// 			}
...
// 				os.Remove(file)
// 				fmt.Fprintln(o.ErrOut, "Edit canceled, no changes made.")
// 				return nil
// 			}
...
// 			if !lines {
// 				os.Remove(file)
// 				fmt.Fprintln(o.ErrOut, "Edit canceled, saved file was empty.")
// 				return nil
// 			}
...
// 		}
// 		if len(infos) == 0 {
// 			return errors.New("edit canceled, no objects found")
// 		}
// 		return editFn(infos)
// 	case ApplyEditMode:
// 		infos, err := o.OriginalResult.Infos()
