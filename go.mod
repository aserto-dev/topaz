...
require (
	...
	github.com/aserto-dev/azm v0.2.20
	github.com/aserto-dev/certs v0.1.1
	github.com/aserto-dev/errors v0.0.17
	github.com/aserto-dev/go-aserto v0.33.20
	...
	github.com/aserto-dev/pb-authorizer/openapi v0.20.20
	github.com/aserto-dev/pb-directory/openapi v0.33.20
	github.com/aserto-dev/runtime v1.13.1
