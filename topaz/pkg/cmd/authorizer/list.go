...
import (
	...
	"github.com/aserto-dev/topaz/topaz/pkg/clients"
	azc "github.com/aserto-dev/topaz/topaz/pkg/clients/authorizer"
	"github.com/aserto-dev/topaz/topaz/pkg/jsonx"
	"github.com/aserto-dev/topaz/topaz/pkg/table"
...
func (cmd *ListPoliciesCmd) Run(c *cc.CommonCtx) error {
	...
	if err := cmd.Invoke(c.Context, authorizer.Authorizer_ListPolicies_FullMethodName, &cmd.req, &cmd.resp); err != nil {
		return err
	}
