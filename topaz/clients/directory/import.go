...
func (c *Client) importHandler(stream dsi.Importer_ImportClient, files []string) func() error {
	return func() error {
...
func (c *Client) importFile(stream dsi.Importer_ImportClient, file string) error {
	r, err := os.Open(file)
	if err != nil {
